program thermistor;
(*
  Use this tool to calibrate the temperature setting on MeterOS
*)
{$APPTYPE CONSOLE}
{$RESOURCE thermistor-data.res}
uses
  SysUtils,
  classes,
  dialogs,
...
I,selUnit:Integer;
TemperatureFormats:array[0..5]of TIdentMapEntry;
...
if(dwtype>maxdword-2)then begin
sleep(2048);
writeln('Press enter to quit...');readln;
end;
exitprocess(ord(dwtype=maxdword-1));
end;
